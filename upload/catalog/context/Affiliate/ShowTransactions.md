# Use case Affiliate - Show Transactions
...
1. Customer selects to show affiliate account transactions
2. System shows the current ballance
3. System shows affiliate account transactions (date, description, amount)

# Code

## controller/affiliate/transaction.php
...
## model/affiliate/transaction.php
...
## view/theme/default/template/affiliate/transaction.tpl
