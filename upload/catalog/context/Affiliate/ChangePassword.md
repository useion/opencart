...
1. Customer selects to change affiliate account password
2. System prompts for password twice
3. Customer enters the password twice
4. System checks the entered passwords are the same (are typed correctly)
5. System saves the password

## Extensions

4a. Password is not between 4 and 20 characters
4a1. System notifies about the password requirements
4a2. Continue to step 2

# Code

## controller/affiliate/password.php
...
## view/theme/default/template/affiliate/password.tpl
