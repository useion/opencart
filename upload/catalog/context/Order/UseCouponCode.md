...
1. Customer selects to use a coupon code
2. System prompts for the coupon code
3. Customer enters the coupon code
4. System applies the coupon code to the order
...
## controller/extension/total/coupon.php
...
## model/extension/total/coupon.php
