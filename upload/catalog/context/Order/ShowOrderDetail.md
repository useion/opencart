...
1. Customer requests to show the order detail
2. System shows the order detail

## Extensions

2a. Customer wants to reorder a product from the order
2a1. System adds the product into cart

## Triggers

The use case is triggered when the "showing orders" extension point is reached

# Code

## controller/account/order.php
...
## view/theme/default/template/account/order_info.tpl
