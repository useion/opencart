...
1. Customer requests to show their wishlist
2. System shows the wishlist
3. System allows delete a product from the wishlist and to add concrete products to be added into shopping cart
...
## view/theme/default/template/account/wishlist.tpl
