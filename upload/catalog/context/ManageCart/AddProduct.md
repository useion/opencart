# Use case Manage Cart - Add Product
...
1. Customer selects to add the product into shopping cart
2. System prompts for quantity and other product attributes
3. Customer enters the quantity and the attributes
4. System saves the product into shopping cart
