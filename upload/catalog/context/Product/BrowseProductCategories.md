# Use case Browse Product Categories
...
1. Customer wants to browse a product category
2. System lists the product categories
3. Customer selects the product category
4. System shows the category description

## Extensions

4a. Customer selects to refine the results with sub-category
4a1. System refines the results
