...
1. Customer wants to find products
2. System prompts for a search criteria (a search text)
3. Customer enters the search text
4. System searches for products based on the search text (full-text)
5. System allows to refine results with a category filter
6. Include "Show Products"
