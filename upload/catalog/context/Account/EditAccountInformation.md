...
1. Customer selects to edit their account information
2. System shows the current account information (name, email, phone, fax)
3. System prompts for an account information and another custom fields
4. Customer enters the information
...
```
## view/theme/default/template/account/edit.tpl
